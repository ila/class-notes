...
Il numero di poli e quello degli zeri corrisponde all'ordine del polinomio che li origina (quindi inizialmente possono essere diversi, ma vengono poi bilanciati con poli/zeri aggiuntivi nell'origine).
